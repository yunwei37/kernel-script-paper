...
| R013 | C3/C4 | Scheduler-extension struct_ops verifier diagnostic | `./experiments/run_sched_ext_verifier.py` | `ccb15b4` KernelScript / working tree after scheduler-extension verifier harness | `results/environment.json` | one generated scheduler-extension object plus one five-callback C/eBPF control baseline, no attach | `results/sched_ext_verifier_summary.json` | done |

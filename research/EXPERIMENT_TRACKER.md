...
| R012 | C3/C4 | Callback-flag tcp-congestion struct_ops workload | `./experiments/run_struct_ops_callback_workload.py` | `ccb15b4` KernelScript / working tree after callback-flag struct_ops harness | `results/environment.json` | 10 trials, 4MiB loopback TCP per variant | `results/struct_ops_callback_workload_summary.json` | done |

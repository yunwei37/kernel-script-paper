...
| R013 | supplement | Scheduler-extension struct_ops verifier diagnostic | `./experiments/run_sched_ext_verifier.py` | one generated object plus one matched C/eBPF baseline, no attach | C/eBPF object verifier-loads and generated failure class is recorded without changing sched_ext state | low | done |

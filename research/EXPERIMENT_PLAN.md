...
- The XDP and TC traffic experiments are local-host evidence, not NIC-rate
  benchmarks.
- The generated scheduler-extension object is verifier-clean on this host, but
  no scheduler is attached; a scheduler workload remains necessary before
  claiming scheduler-extension support. Every callback-level TCP

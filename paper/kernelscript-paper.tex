...
\begin{table}[H]
\centering
\caption{Change amplification for \KSChangeAmpCases{} matched micro-edits (BS = \tool{}, C = hand-written C/libbpf). ``Sync'' reports
...
\begin{table}[H]
\centering
\caption{Staged cross-boundary growth (BS = \tool{}): maintained source footprint for a local
